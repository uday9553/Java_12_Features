...
public class FileMismatchExample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Files.writeString(filePath1,"Uday Sagar Testing");
        Files.writeString(filePath2,"Uday Sagar Testing");
        ...
        Files.writeString(filePath3,"Uday Sagar Testing");
        Files.writeString(filePath4,"Uday Sagar Tesing file");
